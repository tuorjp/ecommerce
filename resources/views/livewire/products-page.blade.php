                            ...
                            @foreach ($categories as $category)
                                <li wire:key="{{$category->id}}" class="mb-4">
                                    <label for="{{$category->slug}}" class="flex items-center dark:text-gray-400 ">
                                        ...
                                        <!-- EM wire:model.live PASSAMOS selected_categories QUE É O MESMO NOME DO ARRAY PÚBLICO
                                         NA CLASSE ProductsPage -->
                            ...
                            @foreach ($brands as $brand)
                                <li wire:key="{{$brand->id}}" class="mb-4">
                                    <label for="{{$brand->slug}}" class="flex items-center dark:text-gray-300">
                                        <input wire:model.live="selected_brands" id="{{$brand->slug}}" value="{{$brand->id}}" type="checkbox" class="w-4 h-4 mr-2">
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="featured" class="flex items-center dark:text-gray-300">
                                    <input wire:model.live="featured" value="1" id="featured" type="checkbox" class="w-4 h-4 mr-2">
                                    <span class="text-lg dark:text-gray-400">Featured Products</span>
                                </label>
                            </li>
                            <li class="mb-4">
                                <label for="on_sale" class="flex items-center dark:text-gray-300">
                                    <input wire:model.live="on_sale" id="on_sale" value="1" type="checkbox" class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range"
                                ...
                                class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="30000"
                                value="10000" step="1000">
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(1000, 'BRL')}}</span>
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        ...
                                        <a href="#" wire:click.prevent="addToCart({{$product->id}})"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                <!-- wire:target="addToCart({{$product->id}})" mostra que só aquele botão tem que mudar para adding... caso não haja esse atributo todos os botões irão exibir a mensagem do loading -->
